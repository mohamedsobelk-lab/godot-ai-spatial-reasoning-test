...
It compares the failed solutions generated by leading AI models against the final, working solution engineered by a human developer. The objective was a complex UI task in **Godot Engine 3.6.1** involving dynamic non-container resizing.
...
> **Prompt:** "I have a VBoxContainer (RowItem) that contains a TextureButton (ButtonAction) which has a child Label (Label). When the label text wraps and increases the label's height, the parent TextureButton and VBoxContainer don't resize. Please advise."
...
*   **Result:** Over-engineered script overrides (deferred calls & signals) that simply failed to trigger the resize.
...
### Before (AI Solutions)
*Notice how the container fails to expand, causing the text to overflow the buttons below.*
...
**Verdict:**  
AI was useful for generating the **boilerplate** (saving 50 ~ 60 % of total minutes of typing), but the **critical thinking** required to solve the architectural constraint took human expertise.
...
> **Attribution:** The concepts, graphs, and breakdown in this repository are part of a research series by **Mohamed Sobhy Elkharashy**. If you share this data or the images, please link back to this repo or my LinkedIn profile: <https://www.linkedin.com/in/mohamed-sobhy-swe/>.
...
- **Concepts, images, documentation, and README** → Licensed under **Creative Commons Attribution‑NonCommercial 4.0 (CC BY‑NC 4.0)**.
